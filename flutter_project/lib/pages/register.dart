          ...
          Expanded(
            child: Center(
              child: SingleChildScrollView(
                child: Container(
                  constraints: const BoxConstraints(maxWidth: 650), // Más ancho
                  margin: const EdgeInsets.all(24),
                  padding: const EdgeInsets.symmetric(vertical: 40, horizontal: 32), // Más padding
                  ...
                  child: Form(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 40), // Más separación del título
                        TextFormField(
